...
class KanbanController extends GetxController {
  ...
  void onTaskAcceptedToBoard(DraggedTask dragData, int boardIndex) {
    boards[dragData.fromBoard].tasks.removeAt(dragData.fromIndex);
    int insertIndex = hoveringIndex.value ?? boards[boardIndex].tasks.length;
    boards[boardIndex].tasks.insert(insertIndex, dragData.task);
